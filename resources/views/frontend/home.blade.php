                                ...
                                <div class="div-table">
                                    <div class="div-cell">
                                        <div class="caption-content">
                                            <h2 class="caption-title">Kendaraaan untuk disewakan</h2>
                                            <h3 class="caption-subtitle"><span>Penawaran Terbaik</span></h3>
                                            <p class="caption-text">
                                                Sales Up <br/>
                                                Semua kendaraaan dapat di sewa dengan harga rendah
                                            </p>
                                            <p class="caption-text">
                                ...
                                <div class="div-table">
                                    <div class="div-cell">
                                        <div class="caption-content">
                                            ...
                                            <h2 class="caption-subtitle">Cari kendaraaan impian mu!<br/> Sewa dengan murah</h2>
                                            <p class="caption-text">
                                                Semua kendaraa tersedia dengan harga termurah di Bali
                                            </p>
                                            <p class="caption-text">
                                                <a class="btn btn-theme btn-theme-md" href="#">See All Vehicles</a>
                                            </p>
                        ...
                        <div class="caption">
                            <div class="container">
                                <div class="div-table">
                                    <div class="div-cell">
                                        <div class="caption-content">
                                            <h2 class="caption-title">Disewakan!</h2>
                                            <h3 class="caption-subtitle">Best Deals</h3>
                                            <p class="caption-text">
                                                Promo!<br/>
                                                Semua kendaraan dapat disewa dengan murah
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="caption">
                                    <div class="caption-wrapper div-table">
                                        <div class="caption-inner div-cell">
                                            ...
                                            <div class="caption-text">text text text text text text text text text text text text text text text text text text text text.</div>
                                            <div class="buttons">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="thumbnail no-border no-padding thumbnail-car-card">
                                        <div class="media">
                                            <a class="media-link" data-gal="prettyPhoto" href="{{ url('assets/frontend') }}/img/preview/cars/car-370x220x1.jpg">
                                                <img src="{{ url('assets/frontend') }}/img/preview/cars/car-370x220x1.jpg" alt=""/>
                                ...
                                <div class="swiper-slide">
                                    <div class="thumbnail no-border no-padding thumbnail-car-card">
                                        <div class="media">
                                            <a class="media-link" data-gal="prettyPhoto" href="{{ url('assets/frontend') }}/img/preview/cars/car-370x220x2.jpg">
                                                <img src="{{ url('assets/frontend') }}/img/preview/cars/car-370x220x2.jpg" alt=""/>
                                                <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                            </a>
                                        </div>
                                        <div class="caption text-center">
                                ...
                                <div class="swiper-slide">
                                    <div class="thumbnail no-border no-padding thumbnail-car-card">
                                        <div class="media">
                                            <a class="media-link" data-gal="prettyPhoto" href="{{ url('assets/frontend') }}/img/preview/cars/car-370x220x3.jpg">
                                                <img src="{{ url('assets/frontend') }}/img/preview/cars/car-370x220x3.jpg" alt=""/>
                                                <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                            </a>
                                        </div>
                                        <div class="caption text-center">
                                ...
                                <div class="swiper-slide">
                                    <div class="thumbnail no-border no-padding thumbnail-car-card">
                                        <div class="media">
                                            <a class="media-link" data-gal="prettyPhoto" href="{{ url('assets/frontend') }}/img/preview/cars/car-370x220x4.jpg">
                                                <img src="{{ url('assets/frontend') }}/img/preview/cars/car-370x220x4.jpg" alt=""/>
                                                <span class="icon-view"><strong><i class="fa fa-eye"></i></strong></span>
                                            </a>
                                        </div>
                                        <div class="caption text-center">
                    ...
                    <div class="testimonial">
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object testimonial-avatar" src="{{ url('assets/frontend') }}/img/preview/avatars/testimonial-140x140x1.jpg" alt="Testimonial avatar">
                                </a>
                            </div>
                            <div class="media-body">
                                <div class="testimonial-text">text text text text text text text text text text text text text text text text text text text text.</div>
