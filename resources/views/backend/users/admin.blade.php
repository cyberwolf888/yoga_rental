...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('backend.users.admin.manage') }}">Admin</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a href="{{ route('backend.users.admin.create') }}" class="btn btn-circle green">
                            ...
                            @foreach($model as $row)
                                <tr>
                                    ...
                                    <td class="center" width="130">
                                        <a href="{{ route('backend.users.admin.edit',$row->id) }}" class="btn yellow-saffron btn-xs"><i class="fa fa-pencil"></i></a>
