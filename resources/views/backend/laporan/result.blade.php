                ...
                <div class="display">
                    <div class="number">
                        <h3 class="font-blue-sharp">
                            <span data-counter="counterup" data-value="{{ $total_transaksi }}">{{ $total_transaksi }}</span>
                        </h3>
                        <small>ORDERS</small>
                    </div>
                    <div class="icon">
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Laporan Periode {{ $start_date }} - {{ $end_date }}</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
